        ...
        template <class HashedObj>
        void QuadraticHashTable<HashedObj>::insertInt( const HashedObj & x )
        {
                // Insert x as active
...
/* 7*/      return currentPos;
        ...
        template <class HashedObj>
        int QuadraticHashTable<HashedObj>::findPosInt( const HashedObj & x ) const
        {
/* 1*/      int collisionNum = 0;
...
/* 7*/      return currentPos;
        ...
        template <class HashedObj>
        void QuadraticHashTable<HashedObj>::removeInt( const HashedObj & x )
        {
            int currentPos = findPosInt( x );
            if( isActive( currentPos ) )
                array[ currentPos ].info = DELETED;
